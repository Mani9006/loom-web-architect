...
import { CoverLetterTemplate } from "@/components/chat/CoverLetterTemplateSelector";
...
export default function CoverLetterPage() {
  ...
  const handleGenerate = async (resumeText: string, jobDescription: string, companyName: string, jobTitle: string, template: CoverLetterTemplate) => {
    ...
    const userMsg: CoverLetterMessage = {
      ...
      content: `Generate a ${template} cover letter for ${jobTitle} at ${companyName}`, timestamp: new Date(),
    };
  ...
  const handleFollowUp = async (message: string) => {
    ...
    setIsLoading(true);
    const userMsg: CoverLetterMessage = { id: crypto.randomUUID(), role: "user", content: message, timestamp: new Date() };
    setMessages((prev) => [...prev, userMsg]);
