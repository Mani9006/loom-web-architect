...
export default function ResumeBuilder() {
  ...
  const handleDownloadPDF = () => {
    if (resumeRef.current) exportToPDF(resumeRef.current, fileName);
  };
  ...
  return (
    <div className="flex h-full w-full overflow-hidden bg-background">
      ...
      <div
        className={cn(
          "w-full lg:w-[38%] lg:min-w-[340px] lg:max-w-[440px] flex flex-col border-r border-border",
                        ...
                        <div className="grid grid-cols-3 gap-x-2 gap-y-1.5">
                          {(
                            [
                              ...
                              { field: "email" as const, label: "Email", placeholder: "john@email.com", type: "email" },
